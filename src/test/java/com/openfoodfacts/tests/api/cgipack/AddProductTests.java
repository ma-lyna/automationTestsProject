...
import com.openfoodfacts.models.AddProductResponseLombokModel;
...
public class AddProductTests {
    ...
    /*
    заменить тестовый сценарии
    1) Успешное обновлениие продукта
    2) Обновленмие инфо о несуществующем продукте
    3) Обновление инфо о продукте из авторизации
    4) обновление инфо о продукте с невалидным паролем
     */
}
